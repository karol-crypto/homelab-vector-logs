# homelab-vector-logs
A low-spec log pipeline solution: collecting [OPNsense](OPNsense) logs via UDP, processing them through an Ubuntu-hosted Vector relay, and securely forwarding JSON-formatted events to a Windows-based Python HTTP receiver for SecOps and homelab analysis.
